...
def main() -> None:
    ...
    relabel_outputs(origin_output, "gc_garch")
    patch_summary(origin_output, "# GC-GARCH Mahalanobis evaluation result", "gc_garch")
    ...
    relabel_outputs(remake2_output, "gc_garch")
    patch_summary(remake2_output, "# GC-GARCH Mahalanobis remake2 result", "gc_garch")

    log = "\n".join(
        [
            "# pair_t_static evaluation",
            f"run_dir: {run_dir}",
            f"mask_dir: {mask_dir}",
